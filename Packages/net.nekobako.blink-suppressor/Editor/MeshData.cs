...
namespace net.nekobako.BlinkSuppressor.Editor
{
    internal class MeshData : IDisposable
    {
        ...
        {
            m_Vertices = new NativeArray<Vertex>(mesh.vertexCount, allocator);
            ...
            m_BoneWeights = new NativeArray<BoneWeight1>(mesh.GetAllBoneWeights(), allocator);
        }

        private void ReadSubMeshes(Mesh mesh, Allocator allocator)
        {
            m_SubMeshes = new NativeArray<SubMesh>(mesh.subMeshCount, allocator);
            ...
            m_Primitives = new NativeArray<Primitive>(primitiveIndex, allocator);
        ...
        {
            m_BlendShapes = new NativeArray<BlendShape>(mesh.blendShapeCount, allocator);
            ...
            m_BlendShapeFrames = new NativeArray<BlendShapeFrame>(blendShapeFrameIndex, allocator);
            ...
            m_BlendShapeDeltas = new NativeArray<BlendShapeDelta>(blendShapeDeltaIndex, allocator);
